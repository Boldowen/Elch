...
export type RefreshTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "tokenHash" | "family" | "userAgent" | "ipAddress" | "expiresAt" | "revokedAt" | "createdAt" | "userId", ExtArgs["result"]["refreshToken"]>;
